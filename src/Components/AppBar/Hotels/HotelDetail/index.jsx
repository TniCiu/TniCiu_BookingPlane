...
import { fetchOneHotels } from "../../../../apis";
    ...
    <Button onClick={handleCloseModal} color="primary">
     ...
     <Paper elevation={3} sx={{ padding: "20px", marginBottom: "20px" }}>
      ...
      <Paper elevation={3} sx={{ padding: "20px", marginBottom: "20px" }} ref={(el) => (sectionsRef.current[3] = el)}>
        ...
        {hotelData.street.name} , {hotelData.street.location.name}, {hotelData.street.location.province.name} {/* Promotion message from the API */}
        </Typography>
